...
export default function HW0() {
  return (
    <div className="p-8 flex flex-col items-center gap-4">
      <h1 className="text-3xl font-bold text-white bg-brown w-full p-4 rounded-xl">Homework 0</h1>
      <div className="flex flex-col justify-center align-center items-center gap-3 bg-beige w-full py-4">
        <p className="text-xl w-1/3 p-1 bg-brown text-white font-bold rounded-[0.5rem] text-center">Face</p>
      ...
      <div className="flex flex-col justify-center align-center items-center gap-3 bg-beige w-full py-4">
        <p className="text-xl w-1/3 p-1 bg-brown text-white font-bold rounded-[0.5rem] text-center">Urban Path</p>
      ...
      <div className="flex flex-col justify-center align-center items-center gap-3 bg-beige w-full py-4">
        <p className="text-xl w-1/3 p-1 bg-brown text-white font-bold rounded-[0.5rem] text-center">GIF</p>
        <div className="flex flex-col gap-2">
